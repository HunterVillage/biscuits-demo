...
public class OrderController {
    ...
    @Action(actionId = "save", method = RequestMethod.POST,authId = "order_manage")
    ...
    @Action(actionId = "audit", method = RequestMethod.POST, authId = "order_manage")
    public Body audit(@RequestParam String uuid) throws Exception {
        this.orderPlusService.audit(uuid);
        return Body.success().data("审核成功");
    }

    @Action(actionId = "rejection", method = RequestMethod.POST, authId = "order_manage")
    ...
    @Action(actionId = "rejection_to_initial", method = RequestMethod.POST, authId = "order_manage")
